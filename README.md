...
## Demo
A YOLOv5 tfjs demo is on https://aukerul-shuvo.github.io/YOLOv5_TensorFlow-JS/. You could drag a file to the center box to detect objects with a pretrained COCO model.
